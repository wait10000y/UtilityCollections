...
- (void)show:(BOOL)animated {
    ...
    [self removeTarget:self action:@selector(hideNow) forControlEvents:UIControlEventTouchUpInside];
...
- (void)hide:(BOOL)animated afterDelay:(NSTimeInterval)delay {
    if (delay >0.3f) {
        [self addTarget:self action:@selector(hideNow) forControlEvents:UIControlEventTouchUpInside];
    }
